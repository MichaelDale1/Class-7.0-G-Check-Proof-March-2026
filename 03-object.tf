resource "aws_s3_object" "index" {
  ...
  key          = "index.html"
  source       = "${path.module}/ARM-7/lab-example/index.html"
  content_type = "text/html"

  etag = filemd5("${path.module}/ARM-7/lab-example/index.html")
...
resource "aws_s3_object" "error" {
  bucket       = aws_s3_bucket.frontend.bucket
  key          = "error.html"
  source       = "${path.module}/ARM-7/lab-example/error.html"
  content_type = "text/html"

  etag = filemd5("${path.module}/ARM-7/lab-example/error.html")
...
#   source = "${path.module}/content/image2.jpg"
#   content_type = "image/jpeg"

#   etag = filemd5("${path.module}/content/image2.jpg")
# }
...
resource "aws_s3_object" "Lab-1c-Bonus-G-Bedrock-Report" {
  ...
  source       = "${path.module}/ARM-7/1c-bonus-G-Cli-Check Artifacts/madibamaximus-20260316-162812.md"
  content_type = "text/markdown"

  etag = filemd5("${path.module}/ARM-7/1c-bonus-G-Cli-Check Artifacts/madibamaximus-20260316-162812.md")
